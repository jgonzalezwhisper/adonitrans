...
<div id="wrap-empresas">
    ...
    <div class="wrap-gestion-empresas" style="display:none">
        ...
        <form id="empresa-form" method="post" class="formplug" autocomplete="off">
					...
					<div class="acordeon-item">
						...
						<div class="acordeon-body">
							<div class="wrap-centro-costos">	
								...
								<button type="button" id="add-centro-row" class="button">Añadir Centro de Costo</button>
							</div>
						</div>
					</div>
					<div class="acordeon-item">
            ...
            <div class="wrap">
                <button class="button" type="submit" id="submit-empresa" name="submit-empresa">Crear Empresa</button>
                <button class="button" type="button" id="cancelar-empresa-btn">Cancelar</button>
            </div>
        </form>
    </div> 
</div>