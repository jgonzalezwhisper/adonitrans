...
<div id="wrap-usuarios">
    <div class="tarjeta">
        ...
        <div class="wrap-listado-usuarios">
            <a href="#" class="button" id="crear-usuario"><i class="icofont-plus-circle"></i> Crear Usuario</a>
            <table id="table-usuarios" class="display table-adoni">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Nombre</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <div class="acciones">
                                    <button class="accion edit-user" data-userid="<?= $user->ID; ?>"><i class="icofont-pencil"></i>Editar</button>
                                    <button class="accion delete-user" data-userid="<?= $user->ID; ?>"><i class="icofont-info-circle"></i>Eliminar</button>
                                </div>
                            </td>
                        </tr>
                    <?php endforeach; ?>
